...
export const DRINKS = category('bebida', { stack: 4, cond: 'drink', tags: ['bebida'] }, [
  ...
  drink('energetico', 'Energético', 'energetico', 0.28, { f: 'can', c: '#2a2a3a', c2: '#8ac83a', k: 'soda' }, 14, 1, 'Tira o sono por um tempo.', { stack: 6, rar: 'incomum', tags: ['cafeina'], drink: { thirst: 14, doses: 1, kcal: 110 } }),
  ...
  drink('cafeLata', 'Café gelado (lata)', 'cafe', 0.25, { f: 'can', c: '#3a2418', c2: '#e8c84a', k: 'soda' }, 10, 1, 'Cafeína pronta.', { stack: 6, rar: 'incomum', tags: ['cafeina'], drink: { thirst: 10, doses: 1, kcal: 120 } }),
]);
