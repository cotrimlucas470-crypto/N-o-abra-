...
const BLOCOS=[
  ...
  {arq:'s52-silencio.js',       ini:'<!-- s52:inicio -->', fim:'<!-- s52:fim -->'},
  {arq:'s53-vigia.js',          ini:'<!-- s53:inicio -->', fim:'<!-- s53:fim -->'},
  {arq:'s54-marcas.js',         ini:'<!-- s54:inicio -->', fim:'<!-- s54:fim -->'},
  {arq:'s55-raros.js',          ini:'<!-- s55:inicio -->', fim:'<!-- s55:fim -->'},
  {arq:'s56-ameaca.js',         ini:'<!-- s56:inicio -->', fim:'<!-- s56:fim -->'},
  {arq:'s57-observador.js',     ini:'<!-- s57:inicio -->', fim:'<!-- s57:fim -->'},
  ...
  {arq:'s62-coisas.js', ini:'<!-- s62:inicio -->', fim:'<!-- s62:fim -->'},
  {arq:'s63-dentro.js', ini:'<!-- s63:inicio -->', fim:'<!-- s63:fim -->'},
  {arq:'s64-passivas.js', ini:'<!-- s64:inicio -->', fim:'<!-- s64:fim -->'},
];
